    ...
    return (
        <div className={styles.v_card_notice}>
            <Stack direction="horizontal" className={styles.row_space_between}>
                <div>
                    <h1 className={`${styles.mediumText} ${styles.blueColorText}`} onClick={() => navigate('/LecPage_notice')} > 돌아가기 </h1>
                </div>
                <div>
                    <h1 className={`${styles.mediumText} ${styles.mainColorText}`} onClick={() => navigate('/LecPage_notice')} > 공지사항 </h1>
                </div>
            </Stack>
